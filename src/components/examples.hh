...
void spawn_angle_link(Renderer& main_renderer) {
  ...
  main_renderer.create_fixed_constraint(main_renderer.m_active_scene->m_loaded_points[2], true);
  ...
  main_renderer.create_length_constraint(main_renderer.m_active_scene->m_loaded_points[0], main_renderer.m_active_scene->m_loaded_points[2], 5.0f);
  main_renderer.create_length_constraint(main_renderer.m_active_scene->m_loaded_points[1], main_renderer.m_active_scene->m_loaded_points[2], 5.0f);
...
void spawn_fix_link(Renderer& main_renderer) {
  ...
  main_renderer.create_fixed_constraint(main_renderer.m_active_scene->m_loaded_points[0], true);
  main_renderer.create_length_constraint(main_renderer.m_active_scene->m_loaded_points[0], main_renderer.m_active_scene->m_loaded_points[1], 5.0f);
  
  };

void spawn_newton_cradle(Renderer& main_renderer) {

  //bottom points
  main_renderer.add_point_to_scene(0.2,5,0);
  main_renderer.add_point_to_scene(0.2,4,0);
  main_renderer.add_point_to_scene(0.0,5,0);
  main_renderer.add_point_to_scene(0.0,4,0);
  ...
  main_renderer.create_spring_constraint(main_renderer.m_active_scene->m_loaded_points[2],main_renderer.m_active_scene->m_loaded_points[3], 200.0f, 4.0f);
