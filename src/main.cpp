...
int main () {
  ...
  main_renderer.add_point_to_scene(0,1,0);
  main_renderer.add_point_to_scene(5,1,0);
  main_renderer.create_spring_constraint(main_renderer.m_active_scene->m_loaded_points[1],main_renderer.m_active_scene->m_loaded_points[0], 1.0f, 2.0f);
